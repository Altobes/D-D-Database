...
public class Frag_Create_Skill {
	 ...
	 */
	public Frag_Create_Skill() {
		initialize();
	}
	
	public Frag_Create_Skill(String PlayerID) {
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) { // Open create character menu
				...
				try {
					cs = dbService.getConnection().prepareCall("{? = call Create_Skill(?, ?, ?)}");
					...
					if (result == 1) {
						...
						JOptionPane.showMessageDialog(null, "Successfully Created Skill");
					}
